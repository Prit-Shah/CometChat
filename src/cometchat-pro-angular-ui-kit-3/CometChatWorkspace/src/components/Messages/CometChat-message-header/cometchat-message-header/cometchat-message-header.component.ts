...
import { CometChatService } from "src/cometchat-pro-angular-ui-kit-3/CometChatWorkspace/src/utils/cometchat.service";
@Component({
      ...
      switch (key) {
        ...
        case enums.TYPING_STARTED: {
          if (
            ...
            this.status =
              item.sender.name + " " + COMETCHAT_CONSTANTS.IS_TYPING;
